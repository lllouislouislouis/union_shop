...
void main() {
  group('Homepage Featured Products Grid Tests', () {
    ...
    testWidgets('grid displays "FEATURED PRODUCTS" title', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        const MaterialApp(
          home: HomeScreen(),
    ...
    testWidgets('grid uses kFeaturedProducts data', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        const MaterialApp(
          home: HomeScreen(),
    ...
    testWidgets('grid layout is 2 columns at 800px width', (WidgetTester tester) async {
      // Arrange
    ...
    testWidgets('grid has correct childAspectRatio', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        const MaterialApp(
          home: HomeScreen(),
    ...
    testWidgets('first product card displays correct data', (WidgetTester tester) async {
      // Arrange
      ...
      expect(find.text('£${firstProduct.price.toStringAsFixed(2)}'), findsOneWidget);
    });

    testWidgets('sale product displays both original and sale price', (WidgetTester tester) async {
      // Arrange
      ...
      // Assert
      expect(find.text('£${saleProduct.originalPrice!.toStringAsFixed(2)}'), findsOneWidget);
      expect(find.text('£${saleProduct.price.toStringAsFixed(2)}'), findsOneWidget);
    });
  });
}
